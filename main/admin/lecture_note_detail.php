<?php
	...
	$lecture_detail_query = "
								SELECT 
									...
									vd.original_name AS vod_file_name, CONCAT(vd.path,'/',vd.save_name) AS vod_path,
								...
								LEFT JOIN file vd
									ON ra.lecture_video_file = vd.idx
								LEFT JOIN nation n
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<th>VOD file</th>
							<td colspan="3">
								<a href="<?=$author_detail1["vod_path"]?>" download><?=$author_detail1["vod_file_name"]?></a>
							</td>
						</tr>
					</tbody>
				</table>
