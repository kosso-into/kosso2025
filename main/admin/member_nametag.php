<?php
	...
	if ($member_idx == "all") {
		$sql_info = "SELECT
                    ...
                    INNER JOIN nation as nat
                        ON nat.idx = mb.nation_no
		...
		$sql_info = "SELECT
                    ...
                    INNER JOIN nation as nat
                        ON nat.idx = mb.nation_no
					WHERE mb.is_deleted = 'N' AND mb.idx = '" . $member_idx ."'";
	}
...
?>
	...
	<link href="/main/css/core.css?rnd=132" rel="stylesheet" type="text/css">
