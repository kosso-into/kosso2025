...
<div class="app_title_box" style="margin-left: 0;">
		...
		-->
			...
			<!-- <div class="floor_area">
				...
				<div class="a_wrap floor_6_3">
					...
					<a href="javascript:;"></a>
					<ul class="pop_text">
                        <li class="floor_pop_title">[사무국]</li>
						<li class="floor_pop_title">3월 8일 (금)</li>
				...
				<div class="a_wrap floor_6_center">
					<a href="javascript:;"></a>
					<ul class="pop_text">
					    <li class="floor_pop_title">[기념품 교환처]</li>
						<li class="floor_pop_title">3월 8일 (금)</li>
						<li>- 운영 시간: 07:30-17:00</li>
						<li class="floor_pop_title">3월 9일 (토)</li>
                        <li>- 운영 시간: 07:30-17:00</li>
