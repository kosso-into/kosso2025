...
<section class="container login_form form_layout find_password login bg style_2023">
    ...
    <h1 class="page_title">비밀번호 찾기
        <p class="yellow_txt">회원가입 시 사용한 이메일을 입력해주세요.</p>
    </h1>
    <div>
        <form name="find_password_form" onsubmit="return false;">
            ...
            <button type="button" class="btn login_btn main_btn"
                onclick="javascript:window.location.href='./login.php';">로그인</button>
        </form>
    </div>
</section>
