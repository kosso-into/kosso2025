					...
					<div>
						<div class="footer_l">
							...
							<ul>
								...
								<li><span>Email.</span> webmaster@kosso.or.kr / <br class="min_br">kosso@kosso.or.kr</li>
								<li><span>Business Registration Number. <br class="min_br"></span>121-82-61144</li>
								<li><span>Chairman.</span> Chang Beom Lee</li>
						...
						<div class="footer_r">
							...
							<ul>
								...
								<li><span>Email :</span> ICOMES@into-on.com</li>
