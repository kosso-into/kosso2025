...
<header class="blue_header">
    <div class="g_h_top">
        <div class="container">
            <div class="dday_wrap">
                <div class="dday_top">D-<span><?= number_format($d_days); ?></span></div>
            ...
            <div class="g_h_logo" style="height: 60px;"></div>
            <ul class="g_h_tool">
                ...
                <li><a href="https://www.kosso.or.kr/">대한비만학회</a></li>
            </ul>
        ...
        <div class="container">
            <div class="nav_wrap pc_only">
                <ul class="depth01 clearfix">
                    <li>
                        <img src="/main/img/footer_logo_mini.png" alt="" class="pointer"
                            onClick="javascript:location.href='/main/index.php'">
                    </li>
                    <li>
                        <a href="/main/welcome.php">메인 페이지</a>
                        <ul class="sub_nav">
                    ...
                    <li>
                        <a href="/main/abstract_submission_guideline.php">초록접수</a>
                        <ul class="sub_nav">
                    ...
                    <li>
                        <a href="/main/registration_guidelines.php">사전등록</a>
                        <ul class="sub_nav">
                    ...
                    <li>
                        <a href="/main/board_notice.php">마이 페이지</a>
                        <ul class="sub_nav">
                            <li><a href="/main/board_notice.php">Notice</a></li>
                            <li><a href="/main/board_newsletter.php">Newsletter</a></li>
                            <li><a href="/main/useful_information.php">Useful Information</a></li>
