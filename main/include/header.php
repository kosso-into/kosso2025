...
<header class="blue_header">
	<div class="g_h_top">
		<div class="container">
			...
			<div class="g_h_logo"><img src="/main/img/icon_logo_blue.svg" alt="" class="pointer" onClick="javascript:location.href='/main/index.php'"></div>
			<ul class="g_h_tool">
				...
				<ul class="depth01 clearfix">
					...
					<li>
						...
						<ul class="sub_nav">
                            ...
                            <li><a href="/main/invited_speaker.php">Scientific Program</a></li>
					...
					<li>
						...
						<ul class="sub_nav">
							...
							<li><!-- <a href="/main/abstract_submission_guideline.php">Abstract Submission Guideline</a> --></li>
...
<div class="m_nav_wrap">
	...
	-->
	<div class="m_nav_top">
		<img src="/main/img/icon_logo_blue.svg" alt="" class="pointer logo" onclick="javascript:location.href='/main/index.php'">
		<button type="button" class="n_nav_close"><img src="/main/img/icons/m_nav_close.svg"></button>
	</div>
	<div class="m_nav">
        <ul class="m_nav_ul">
            <li class="m_nav_li">
                <a href="javascript:;" class="<?= (in_array($_page, $_page_config["m1"]) ? "show" : "") ?>"><span>ICOMES 2023</span></a>
