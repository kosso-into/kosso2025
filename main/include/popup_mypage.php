...
<div class="popup mp_pop">
	...
	<div class="pop_contents">
		<h1 class="pop_title clearfix">
			...
			<img class="pop_close pointer floatR" src="/main/live/images/icon/icon_x.png" alt="아이콘_x">
		</h1>
		<div class="pop_cont">
			<div class="alert">
...
<script>
    ...
    $(".mp_pop .pop_close").click(function(){
        $(this).parents(".popup").removeClass("on");
        $(".mp_pop").hide();
    })

	//탭
	$(".mp_pop .tab_pager li").click(function () {
		var _this = $(this);

		var _targets = $(".mp_pop .tab_pager li");
		var i = 0;
