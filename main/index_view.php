	...
	<div class="section_bg">
		...
		<div class="container">
			...
			<div class="txt_wrap">
				...
				<p class="e_fullname">2023 <b class="point_txt f_bold">I</b>nternational <b class="point_txt f_bold">C</b>ongress on <b class="point_txt f_bold">O</b>besity and <b class="point_txt f_bold">ME</b>tabolic <b class="point_txt f_bold">S</b>yndrome hosted by KSSO
				</p>
				<p class="e_place">
					<?php
				...
				<div class="board_area box2">
					...
					<div>
						<h1 class="board_title slider-for slick-initialized slick-slider">Key Dates<div class="slick-list draggable">
						...
						<ul class="main_page_btn half_ul">
							<li>
								<button type="button" class="board_btn" onclick="javascript:window.location.href='./abstract_submission_guideline.php';">Call
									for Abstracts</button>
							</li>
							<li>
								<button type="button" class="board_btn" onclick="javascript:window.location.href='./registration_guidelines.php';">Go to
									Registration</button>
							</li>
						</ul>
					</div>
...
<div class="fixed_btn_wrap">
	<ul class="toolbar_wrap">
		<li><button type="button" onclick="location.href='/main/board_notice.php'"><i><img src="/main/img/icons/tool_faq.svg" alt=""></i>Notice</button></li>
		<li><button type="button" onclick="location.href='/main/registration.php'"><i><img src="/main/img/icons/tool_regist.svg" alt=""></i>Registration</button></li>
		<li><button type="button" onclick="location.href='/main/abstract_submission.php'"><i><img src="/main/img/icons/tool_abstract.svg" alt=""></i>Abstract</button></li>
		<li><button type="button" onclick="alert('Need to login.')"><i><img src="/main/img/icons/tool_mypage.svg" alt=""></i>My page</button></li>

	</ul>
	<button type="button" class="btn_top" style="display: inline-block;"><img src="/main/img/icons/icon_top_btn.svg" alt=""></button>
</div>
<!-- page loading bar 주석-->
