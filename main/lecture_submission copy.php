				...
				<form name="lecture_form">
					<ul class="basic_ul">
						...
						<li>
							...
							<div class="name_div">
								<input class="required3" type="text" name="first_name" value="<?=$first_name?>" maxlength="50">
								<input class="required3" type="text" name="last_name" value="<?=$last_name?>" maxlength="50">
							</div>
						</li>
						<li>
							<p class="label"><?=$locale("affiliation")?> *</p>
							<div>
								<input class="required3" type="text" name="affiliation" value="<?=$affiliation?>" maxlength="100">
							</div>
						</li>
						<li>
					...
					<div class="btn_wrap rightT">
						<button type="button" class="btn online_btn green_btn" <?=$lecture_idx ? "data-idx='".$lecture_idx."'" : ""?>>Next<span>></span></button>
...
$(document).ready(function(){
	...
	$('.number_of_author').on('change',function(){
		...
		for (var i = 1 ; i < num ; i++){ 
			...
			html +=				'<td><input class="required3" type="text" name="co_city'+i+'" value="" maxlength="100"></td>';
			html +=			'</tr>';
			html +=			'<tr>';
			...
			html +=				'<td><input class="required3" type="text" name="co_first_name'+i+'" value="" maxlength="50"></td>';
			html +=			'</tr>';
			html +=			'<tr>';
			html +=				'<th><?=$locale("last_name")?> *</th>';
			html +=				'<td><input class="required3" type="text" name="co_last_name'+i+'" value="" maxlength="50"></td>';
			html +=			'</tr>';
			html +=			'<tr>';
			html +=				'<th><?=$locale("affiliation")?> *</th>';
			html +=				'<td><input class="required3" type="text" name="co_affiliation'+i+'" value="" maxlength="100"></td>';
			html +=			'</tr>';
			html +=			'<tr>';
			html +=				'<th><?=$locale("email")?> *</th>';
			html +=				'<td><input class="required3" type="text" name="co_email'+i+'" value="" maxlength="100"></td>';
			html +=			'</tr>';
			html +=			'<tr>';
			...
			html +=						'</select>';
			html +=						'<input class="required3" type="text" placeholder="010-0000-0000" name="co_phone'+i+'" value=""></td>';
			html +=					'</div>';
			html +=				'</td>';
			html +=			'</tr>';
			html +=		'</table>';
