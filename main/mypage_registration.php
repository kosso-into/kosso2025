...
<section class="mypage container">
            ...
            <table class="table_vertical registration_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Complete</td>
                        <td>
                            <button type="button" class="btn review_regi_open"
                                data-idx="<?= $list["idx"] ?>">등록정보</button>
                            <button type="button" class="btn registration_receipt_btn"
                                data-idx="<?= $list["idx"] ?>">영수증</button>
    ...
    <div class="popup review_regi_pop">
        ...
        <div class="pop_contents">
            ...
            <div class="btn_wrap">
                <button type="button" class="btn cancel_btn" name="registration_cancel_pop_btn"
                    style="position:static; width:auto; height:auto; padding:8px 30px;">등록 취소</button>
            </div>
        </div>
    </div>
        ...
        <div class="pop_contents">
            ...
            <tr>
                ...
                <td class="banquet_style">
                    <input type="radio" class="radio" id="applied" name="rating" value="1"><label class="banquet_label"
                        for="applied">신청</label>
                    <input type="radio" class="radio" id="not_applied" name="rating" value="0"><label
                        for="not_applied">미신청</label>
                </td>
            </tr>
            <tr class="org tab_contents">
                <th><?php echo $locale("applied_org") ?></th>
                <td>
                    <input type="checkbox" class="checkbox org_01" id="checkbox1" name="org" value="1"><label
                        for="checkbox1"><?php echo $locale("applied_org1") ?></label></br>
                    <input type="checkbox" class="checkbox registration_check org_03" id="checkbox3" name="org"
                        value="3"><label for="checkbox3"><?php echo $locale("applied_org3") ?></label></br>
                    <input type="checkbox" class="checkbox registration_check org_04" id="checkbox4" name="org"
                        value="4"><label for="checkbox4"><?php echo $locale("applied_org4") ?></label></br>
                </td>
            </tr>
            <tr>
