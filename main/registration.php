...
$sql_during =    "SELECT
						IF(NOW() BETWEEN '2022-08-18 17:00:00' AND '2024-02-28 16:00:00', 'Y', 'N') AS yn
					FROM info_event";
$during_yn = sql_fetch($sql_during)['yn'];
//!=="Y"

// sujeong / 사용한 member_type, attendance_type !!!

//Professor: 교수, Certified M.D.: 개원의, Public Health Doctor: 봉직의, Corporate Member: 교직의(삭제), 
...
//참가유형(0: 임원, 1:연자, 2:좌장, 3:패널, 4:일반참석자, 5:고객사, 6:기자, 7:심사, 8:전공의 및 의대생, 9:학회)
if ($during_yn != "Y") {
