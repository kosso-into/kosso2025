...
<section class="submit_application payment container registration2">
    <div class="inner">
        ...
        <div class="section section1 input_area">
                ...
                <div class="table_wrap detail_table_common">
                    <table class="c_table detail_table">
                        ...
                        <tbody>
                            <tr>
                                <th>
                                    <!--<?= $locale("online_offline") ?>-->Attendance Type
                                </th>
                            ...
                            <tr>
                                <th>
                                    <!--<?= $locale("price") ?>-->Registration Fee
                                </th>
                                <td><?= (($nation_no == 25) ? number_format($ko_price) : number_format($price)) . " " . $cur ?>
                                </td>
                            </tr>
                            <!--
                            <tr>
            ...
            <div class="details">
                <ul>
                    <li><?= $locale("total_price") ?> <span
                            class="point_txt s_bold"><?= (($nation_no == 25) ? number_format($ko_price) : number_format($price)) . " " . $cur ?></span>
                    </li>
            ...
            <div class="btn_wrap text_center">
                ...
                if ($nation_no == 25) {
                ?>
                <button type="button" class="btn long_btn submit" onclick="kgpay();">
                    <!--<?= $locale("d_payment_btn") ?>--> payment >
                </button>
                <?php
                } else {
                ?>
                <button type="button" class="btn long_btn submit" onclick="payment();">
                    <!--<?= $locale("payment_btn") ?>--> payment >
                </button>
                <?php
                }
                ?>
    ...
    <form class="form-horizontal" name="regForm" method="post"
        action="https://kosso.org/main/plugin/eximbay/request.php">
        <!-- 결제에 필요 한 필수 파라미터 -->
    ...
    <div class="popup cancel_pop">
        ...
        <div class="pop_contents cancel_details">
            ...
            <p class="pre">
                <!--<?= $locale("cancellation_txt") ?>-->* For administrative reasons, please note that refunds will be
                issued after the end of the event.
                - If you are registered but are not able to attend or need to cancel your registration, you can cancel
                your registration in "My page" before the end of the pre-registration period.
                - Refunds will be made immediately upon receipt of the written notice after the end of the society
                meeting.
                - All bank fees must be paid by the register.
                - If pre-registration fee was paid by credit card, refunds will be made after deducting the card fee.
            </p>
