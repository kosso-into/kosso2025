		...
		<div class="details">
			...
			<div class="mt10">
				<ul class="indent_ul">
					...
					<li class="red_txt bold">• 입/퇴실 시 (1일 2회) 명찰의 바코드를 입출결 확인 시스템에 태깅하여 주십시오.</li>
                    <li>• 입/퇴실 시 바코드를 태깅하지 않은 경우 이수 시간이 인정되지 않습니다.</li>
                    <li>• 휴게 시간 및 식사 시간(20분)은 이수 시간에 포함되지 않습니다.</li>
                    <li>• 이수 시간은 학술대회 교육 시작 시간부터 종료 시간 내에서만 인정됩니다.</li>
                    <li>• 내과전공의 외부학술회의 평점은 3시간 이상 참석 시 1점, 6시간 이상 참석 시 2점으로 발급됩니다.</li>
