...
<section class="container form_page sign_up">
		...
		<div class="sub_inner">
			...
			<div class="term_wrap">
				...
				<div class="term_box">
					...
					<p>Korean Society for the Study of Obesity(KSSO) provides pre-registration services online for ICOMES 2023. Based on your personal information, you can sign up for the conference and complete the payment of your registration fee.</p>
					<strong>Collecting Your Personal Information</strong>
					<p>ICOMES 2023 requires you to provide your personal information to complete pre-registration online. You will be asked to enter your Name, ID (E-mail), Password, Date of Birth, Institution/Organization, Department, Mobile, and Telephone Number.</p>
					<strong>Storing of Your Personal Information</strong>
					<p>ICOMES 2023 will keep storing of your personal information to provide you with ICOMES 2023’s useful services such as conference updates and newsletters.</p>
				</div>
	...
	<div class="inner">
		<div class="circle_title">
			...
			<span class="mini_alert">* All requested filed(*) should be completed.</span>
		</div>
			...
			<div class="pc_only">
				<table class="table detail_table">
					...
					<tbody>
						...
						<tr class="korea_radio">
							...
							<td>
								<div class="label_wrap">
									<input type="radio" class="radio" name="user" id="user1">
									<label for="user1">회원</label>	
									<input checked type="radio" class="radio" name="user" id="user2">
									<label for="user2">비회원</label>	
								</div>
							</td>
						</tr>
						...
						<tr>
							<td class="font_small brown_txt">Note.<br/>your name will appear on your name badge exactly as it is entered in these fields.<br/>It you wish your name to appear in a specific way, please contact the Secretariat via<br/>e-mail(secretariat@icola2022.org)</td>
						</tr>
						<tr class="korea_only">
						...
						<tr>
							<td class="font_small brown_txt">Please enter your phone number including the country and area codes. <br/> (Example: +82-2-12345678)</td>
						</tr>
						<tr>
			...
			<div class="mb_only">
				<ul class="sign_list">
					...
					<li>
						...
						<p class="font_small brown_txt">Please enter your phone number including the country and area codes. <br/> (Example: +82-2-12345678)</p>
						<!-- <div> -->
						<!-- 	<span class="mini_alert red_txt mo_red_alert"></span> -->
						<!-- 	<span class="mini_alert red_txt mo_red_alert"></span> -->
						<!-- </div> -->
...
$(document).on("click", "#mo_submit", function(){
	...
	var department_kor = $("#mo_department_kor option:selected").val();
...
$(document).on("click", "#submit", function(){
	...
	// 휴대폰 유효성
	var phone_num = $("input[name=phone]").val();
	if(!phone_check(phone_num, nation_no)) return;
	...
	var department_kor = $("#department_kor option:selected").val();
