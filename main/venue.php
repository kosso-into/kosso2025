...
<section class="container venue <?= $add_section_class; ?>">
    ...
    <div class="app_title_box">
        <h2 class="app_title">ICOMES 2023<button type="button" class="app_title_prev"
            ...
            <div>
                ...
                <ul class="app_overview_ul app_venue_info">
                    <li>
                        ...
                        <div class="flex_top">
                            <p>주소</p>
                            <p>04963) 서울특별시 광진구 워커힐로 177 워커힐호텔</p>
                        </div>
                        <div class="flex_top">
                            <p>대표번호</p>
                            <p>1670-0005</p>
                        ...
                        <div class="flex_top">
                            <p>Website</p>
                            <p><a href="https://www.walkerhill.com/grandwalkerhillseoul/" class="link"
                                    target="_blank">https://www.walkerhill.com/grandwalkerhillseoul/</a></p>
                        </div>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="clearfix2">
                            <div class="info">
                                    ...
                                    <div class="table_wrap detail_table_common x_scroll">
                                        <table class="c_table">
                                            <tbody>
                                                <tr>
                                                    <th>Board</th>
                                                    <td>Terminal 1 : Arrival Gate 6B-1 (1F) / Terminal 2 : Arrival Gate
                                                        27 (B1)</td>
                                                </tr>
                                                <tr>
                                                    <th>Travel Time</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        - Location of airport ticket counter. Terminal 1 Gate 6~13 (1F)
                                                        / Terminal 2 : Eastside B1<br>
                                                        - K-Limousine Website : <a
                                                            href="http://www.klimousine.com/eng/main" target="_blank"
                                                            class="link">www.klimousine.com</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="airplane_cont">
                                    <h5>By Subway</h5>
                                    <p>
                                        The Airport Railroad Express (AREX) provides transportation services that
                                        connect Incheon International Airport and Gimpo Airport. Passengers arriving at
                                        Gimpo Airport have the option to transfer to Subway Line 9 for further
                                        transportation. You can take the AREX (Airport Railroad Express) at the Incheon
                                    ...
                                    <div class="table_wrap detail_table_common x_scroll">
                                        <table class="c_table type1">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="venue_airplane" src="./img/venue_airplane1.svg"
                                                            alt=""></td>
                                                ...
                                                <tr>
                                                    <td><img class="venue_airplane" src="./img/venue_airplane2.svg"
                                                            alt=""></td>
                                                    <td>Approx. T2: 78 min <br>Approx. T1: 70 min</td>
                                                ...
                                                <tr>
                                                    <td><img class="venue_airplane" src="./img/venue_airplane3.svg"
                                                            alt=""></td>
                                ...
                                <div class="airplane_cont">
                                    <h5>By Taxi</h5>
                                    <p>Taxi services are always available, and the fare from Incheon International
                                        Airport to the Venue (Conrad Seoul) is approximately KRW 55,000 for a standard
                                        taxi. The expressway fee (KRW 7,100 each way) will be added to the total fare.
                                        The rides take about 40-50 minutes. However, it may vary depending on traffic
                                        conditions. There is an additional fee for taxi rides taken between 22:00 pm and
                                        4:00 am, resulting in an approximate 20%~ 40% increase in the fare.</p>
                                    <div class="table_wrap detail_table_common x_scroll">
                                        <table class="c_table type2">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>5C, 6C, 6D</td>
                                                    <td>5C</td>
                                                    <td>22:00 - 04:00<br />Additional late-night charge of 20% ~ 40%
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        language service<br>
                                                        For reservation: <a href="http://www.intltaxi.co.kr"
                                                            target="_blank" class="link">www.intltaxi.co.kr</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="taxi_text_area">
                                        For more information on each mode of transportation and the related services,
                                        please visit the websites below.
                                        <div>
                                            -
                                            <a href="https://www.airport.kr/ap/en/index.do" target="_blank"
                                                class="link">Incheon International Airport(click!) </a>
                                            /
                                            <a href="https://www.airport.co.kr/gimpoeng/index.do" target="_blank"
                                                class="link">Gimpo International Airport(click!)</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
