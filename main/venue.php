...
<section class="container venue <?= $add_section_class; ?>">
    ...
    ?>
        <div class="app_title_box">
            <h2 class="app_title">춘계학술대회<button type="button" class="app_title_prev" onclick="javascript:window.location.href='./app_index.php';"><img src="/main/img/icons/icon_arrow_prev_wh.svg" alt="이전페이지로 이동"></button></h2>
            <ul class="app_menu_tab">
                <li><a href="./welcome.php">초대의 글</a></li>
    ...
    <div class="inner">
        ...
        <ul class="app_overview_ul app_venue_info">
                    <li>
                        ...
                        <div class="flex_top">
                            <p>Website</p>
                            <p><a href="https://www.walkerhill.com/grandwalkerhillseoul/" class="link" target="_blank">https://www.walkerhill.com/grandwalkerhillseoul/</a></p>
                        </div>
                    </li>
                </ul>
                </div>
